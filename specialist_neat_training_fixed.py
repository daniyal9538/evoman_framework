...
if __name__ == '__main__':
    ...
    parser.add_argument('--individual_type', help='type of individual (nn) (1: ff nn, 2: rnn, 3: ff_fixed)', default=1,type=int)
    ...
    for enemy in ENEMIES:
        for run in range(1, 11):
            file_name = "neat_fixed_stats_run-{}_enemy-{}_ind-3".format(run, enemy, str(INDIVIDUAL_TYPE))
            ...
            winner_file = "neat_fixed_best_run-{}_enemy-{}_ind-3.pkl".format(run, enemy, str(INDIVIDUAL_TYPE))
